...
//,/
/// # Safety
/// This function is unsafe because the caller must gaurantee that the complete
...
pub struct BootInfoFrameAllocator {
    /// A reference to the memory map passed by the bootloader.
    memory_map: &'static MemoryMap,
    /// Keeps track of the next frame that the allocator should return.
    next: usize,
}
...
impl BootInfoFrameAllocator {
    ...
    /// are marked as `USABLE` in it really are unused.
